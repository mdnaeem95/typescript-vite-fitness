...
const benefits: Array<BenefitType> = [
    {
        ...
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate aliquid, repellendus maiores ad consectetur recusandae."
    },
    {
        icon: <UserGroupIcon className="h-6 w-6"/>,
        title: "100's of Diverse Classes",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora quos, inventore ipsum consectetur ex debitis!"
    },
    {
        icon: <AcademicCapIcon className="h-6 w-6"/>,
        title: "Expert and Pro Trainers",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Non laboriosam, in dicta perferendis officiis veritatis."
    },
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
            ...
            <div>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5  }} transition={{ delay: 0.2, duration: 0.5 }} variants={{ hidden: { opacity: 0, x:50 }, visible: { opacity: 1, x: 0 } }}>
                    <p className="my-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit ex neque doloremque delectus, corporis dolore voluptatum? Tenetur iure libero optio, fugit consequatur facilis nisi odio perferendis dolor laudantium molestias commodi asperiores hic accusamus ex recusandae!</p>
                    <p className="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, quod praesentium distinctio nesciunt reprehenderit, animi facilis excepturi provident corrupti aliquid repudiandae cumque dolorum laboriosam accusamus esse expedita alias? Voluptas, laborum.</p>
                </motion.div>
