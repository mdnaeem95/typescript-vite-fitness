    ...
    return <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
            ...
            <motion.div className="md:w-3/5" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5  }} transition={{ duration: 0.5 }} variants={{ hidden: { opacity: 0, x:-50 }, visible: { opacity: 1, x: 0 } }}>
                ...
                <p className="my-5">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores, incidunt sit amet esse quis fuga dolorem quo dicta laudantium? Perspiciatis soluta tempora quod dicta sed eius, ea doloribus a accusantium.
                </p>
            </motion.div>
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                <motion.div className="mt-10 basis-3/5 md:mt-0" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5  }} transition={{ duration: 0.5 }} variants={{ hidden: { opacity: 0, y:50 }, visible: { opacity: 1, y: 0 } }}>
                    <form target="_blank" onSubmit={onSubmit} method="POST" action="https://formsubmit.co/muhdnaeem95@gmail.com">
