    ...
    <motion.div className="mx-auto w-5/6 items-center justify-center md:flex md:h-5/6" onViewportEnter={() => setSelectedPage(SelectedPage.Home)}>
        ...
        <div className="z-10 mt-32 md:basis-3/5">
            <motion.div className="md:-mt-20" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5  }} transition={{ duration: 0.5 }} variants={{ hidden: { opacity: 0, x:-50 }, visible: { opacity: 1, x: 0 } }}>
                ...
                <p className='mt-8 text-sm'>Unrivaled Gym. Unparalled Training Fitness Classes. World Class Studios to get the body shapes that you dreamt of. Get Your Dream Body Now.</p>
            </motion.div>
            {/* ACTIONS */}
